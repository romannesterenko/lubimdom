...
$templateData['PROPERTIES']['NABORS'] = $arResult['PROPERTIES']['NABORS'];
$templateData['PROPERTIES']['SERIE_ELEMS'] = $arResult['PROPERTIES']['SERIE_ELEMS'];
$templateData['PROPERTIES']['ADDITIONAL_PRODUCTS'] = $arResult['PROPERTIES']['ADDITIONAL_PRODUCTS'];
...
<div class="product-info <?=(!$showCustomOffer ? "noffer" : "");?> bordered rounded3" id="<?=$arItemIDs["strMainID"];?>">
					...
					<div class="prices_block">
                        ...
                        <?ob_start()?>
                            ...
                            <div class="buy_block">
								...
								<span class="btn btn-transparent-border-color  type_block transition_bg one_click has-ripple" data-autoload-product_name="<?=$arResult['NAME']?>" data-autoload-product_id="<?=$arResult['ID']?>" data-event="jqm" data-param-form_id="SIMPLE_FORM_12" data-name="simple_form_12">
									<span>Заказать бесплатный дизайн проект</span>
								</span>
                                </div>
                            </div>
                        </div>
                        <?$product_buy = ob_get_clean();?>
    ...
    <?if(count($arResult['CARACHTERISTICS'])>0){?>
        <div class="ordered-block char">
            ...
            <div class="char_block bordered rounded3 js-scrolled">
                <table class="props_list nbg">
                    <tbody>
                        <?foreach ($arResult['CARACHTERISTICS'] as $CARACHTERISTIC){?>
                            <tr>
                                <td class="char_name">
                                    <div class="props_item ">
                                        <span itemprop="name"><?=$CARACHTERISTIC['NAME']?></span>
                                    </div>
                                </td>
                                <td class="char_value">
                                    <span itemprop="value">
                                        <?=$CARACHTERISTIC['VALUE']?>
                                    </span>
                                </td>
                            </tr>
                        <?}?>
                ...
                <table class="props_list nbg" id="bx_117848907_10992_sku_prop"></table>
            </div>
        </div>
    <?}?>
    <div class="ordered-block char">
        ...
        <div class="char_block bordered rounded3 js-scrolled">
            <div class="row advantage_block">
                <?foreach($arResult['ADVANTAGES'] as $ADVANTAGE){
                    ?>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12 advantage_item" style="text-align: center">
                        <div>
                            <img src="<?=$ADVANTAGE['PREVIEW_PICTURE']?>" alt="">
                        </div>
                        <div class="advantage_descr" style="text-align: center">
                            <?=$ADVANTAGE['NAME']?>
                        </div>
                    </div>
                    <?
...
<?if($arResult['VIDEO']):?>
    ...
    <?$this->EndViewTarget();?>
<?endif;?>
<?$show = $arResult['PROPERTIES']['SHOW_COUNT']['VALUE']>0?$arResult['PROPERTIES']['NABORS']['VALUE']:10;?>
<?if(count($arResult['PROPERTIES']['NABORS']['VALUE'])>0):?>
	<?$templateData['DETAIL_TEXT'] = true;?>
	<?$this->SetViewTarget('PRODUCT_NABORS_INFO');?>
		<div class="content" itemprop="description">
            <div class="ordered-block">
                <?
                global $NaborsFilter;
                $NaborsFilter['ID'] = $arResult['PROPERTIES']['NABORS']['VALUE'];
                $APPLICATION->IncludeComponent(
	...
	<?$this->EndViewTarget();?>
<?endif;?>
<?if(count($arResult['PROPERTIES']['MAYBE_YOU_LIKE']['VALUE'])>0):?>
    <?$this->SetViewTarget('MAYBE_YOU_LIKE');?>
    <div class="ordered-block char">
        <div class="ordered-block__title option-font-bold font_lg">
        ...
        <div class="char_block bordered rounded3 js-scrolled">
            <div class="content" itemprop="description">
                ...
                <div class="ordered-block">
                    <?
                    global $MAYBE_YOU_LIKEFilter;
                    $MAYBE_YOU_LIKEFilter['ID'] = $arResult['PROPERTIES']['MAYBE_YOU_LIKE']['VALUE'];
                    $APPLICATION->IncludeComponent(
                        "bitrix:catalog.section",
                        'catalog_block',
                        Array(
                            ...
                            "ELEMENT_SORT_FIELD2" => $arParams["ELEMENT_SORT_FIELD2"],
                            "ELEMENT_SORT_ORDER2" => $arParams["ELEMENT_SORT_ORDER2"],
                            "FILTER_NAME" => 'MAYBE_YOU_LIKEFilter',
                            "INCLUDE_SUBSECTIONS" => $arParams["INCLUDE_SUBSECTIONS"],
                            "PAGE_ELEMENT_COUNT" => $show,
                            "LINE_ELEMENT_COUNT" => 3,
                            "SET_LINE_ELEMENT_COUNT" => $bSetElementsLineRow,
...
<?if(count($arResult['PROPERTIES']['WITH_THIS_PRODUCT_BUY']['VALUE'])>0):?>
    <?$this->SetViewTarget('WITH_THIS_PRODUCT_BUY');?>
    <div class="ordered-block char">
        <div class="ordered-block__title option-font-bold font_lg">
        ...
        <div class="char_block bordered rounded3 js-scrolled">
            <div class="content" itemprop="description">
                ...
                <div class="ordered-block">
                    <?
                    global $WITH_THIS_PRODUCT_BUYFilter;
                    $WITH_THIS_PRODUCT_BUYFilter['ID'] = $arResult['PROPERTIES']['WITH_THIS_PRODUCT_BUY']['VALUE'];
                    $APPLICATION->IncludeComponent(
                        "bitrix:catalog.section",
                        'catalog_block',
                        Array(
                            ...
                            "ELEMENT_SORT_FIELD2" => $arParams["ELEMENT_SORT_FIELD2"],
                            "ELEMENT_SORT_ORDER2" => $arParams["ELEMENT_SORT_ORDER2"],
                            "FILTER_NAME" => 'WITH_THIS_PRODUCT_BUYFilter',
                            "INCLUDE_SUBSECTIONS" => $arParams["INCLUDE_SUBSECTIONS"],
                            "PAGE_ELEMENT_COUNT" => $show,
                            "LINE_ELEMENT_COUNT" => 3,
                            "SET_LINE_ELEMENT_COUNT" => $bSetElementsLineRow,
    ...
    <?$this->EndViewTarget();?>
<?endif;?>
<?if(count($arResult['PROPERTIES']['SERIE_ELEMS']['VALUE'])>0):?>
	<?$this->SetViewTarget('PRODUCT_SERIE_ELEMS_INFO');?>
    <div class="content" itemprop="description">
        <?/*=$arResult['DETAIL_TEXT'];*/?>
        <div class="ordered-block">
            <?
            global $ElemSeriesFilter;
            $ElemSeriesFilter['ID'] = $arResult['PROPERTIES']['SERIE_ELEMS']['VALUE'];
            $APPLICATION->IncludeComponent(
                "bitrix:catalog.section",
                'catalog_block',
                Array(
	...
	<?$this->EndViewTarget();?>
<?endif;?>
<?if(count($arResult['PROPERTIES']['ADDITIONAL_PRODUCTS']['VALUE'])>0):?>
	<?$this->SetViewTarget('PRODUCT_ADDITIONAL_PRODUCTS_INFO');?>
    <div class="content" itemprop="description">
        <?/*=$arResult['DETAIL_TEXT'];*/?>
        <div class="ordered-block">
            <?
            global $ADDITIONAL_PRODUCTSFilter;
            $ADDITIONAL_PRODUCTSFilter['ID'] = $arResult['PROPERTIES']['ADDITIONAL_PRODUCTS']['VALUE'];
            $APPLICATION->IncludeComponent(
                "bitrix:catalog.section",
                'catalog_block',
                Array(
                    ...
                    "ELEMENT_SORT_FIELD2" => $arParams["ELEMENT_SORT_FIELD2"],
                    "ELEMENT_SORT_ORDER2" => $arParams["ELEMENT_SORT_ORDER2"],
                    "FILTER_NAME" => 'ADDITIONAL_PRODUCTSFilter',
                    "INCLUDE_SUBSECTIONS" => $arParams["INCLUDE_SUBSECTIONS"],
                    "PAGE_ELEMENT_COUNT" => $show,
                    "LINE_ELEMENT_COUNT" => 3,
                    "SET_LINE_ELEMENT_COUNT" => $bSetElementsLineRow,
